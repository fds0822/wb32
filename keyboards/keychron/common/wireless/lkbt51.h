...
#ifndef BT_DRIVER
#    define BT_DRIVER SPIDQ
#endif

#ifdef USE_GPIOV1
#    ifndef BT_DRIVER_UART_TX_PAL_MODE
#        define BT_DRIVER_UART_TX_PAL_MODE PAL_MODE_WB32_ALTERNATE_PUSHPULL
#    endif
#    ifndef BT_DRIVER_UART_RX_PAL_MODE
#        define BT_DRIVER_UART_RX_PAL_MODE PAL_MODE_WB32_ALTERNATE_PUSHPULL
#    endif
#else
...
#    error "BT driver activated but no SPI peripheral assigned"
#endif
