...
#    endif
    if (IS_NOEVENT(record.event) || pre_process_record_quantum(&record)) {LOG_TRACE("AE-1 ");
 ...
 * FIXME: Needs documentation.
 */
void process_record(keyrecord_t *record) {LOG_TRACE("PR-1 ");
    ...
    process_record_handler(record);LOG_TRACE("PR-4 ");
    post_process_record_quantum(record);LOG_TRACE("PR-5 ");
}
